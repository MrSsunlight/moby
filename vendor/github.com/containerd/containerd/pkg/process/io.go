...
func (c *countingWriteCloser) Close() error {
	if atomic.AddInt64(&c.count, -1) > 0 {
		return nil
<<<<<<< HEAD:vendor/github.com/containerd/containerd/runtime/v1/linux/proc/io.go
	}
...
func isFifo(path string) (bool, error) {
	...
	if stat.Mode()&os.ModeNamedPipe == os.ModeNamedPipe {
		return true, nil
=======
>>>>>>> 0906c7fae9345571e51d6103eb90774d5f408375:vendor/github.com/containerd/containerd/pkg/process/io.go
	}
	return c.WriteCloser.Close()
}
